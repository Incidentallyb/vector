module GameData exposing (CheckboxData, GameData, NotificationCount, ScoreType(..), emailContainsPendingDecision, filterDocuments, filterEmails, filterMessages, filterSocials, filteredSocials, getStringIfMatchFound, init, keyedSocialsList, notificationsInit, unactionedEmailChoices, unactionedMessageChoices, updateScore)
