module GameData exposing (CheckboxData, GameData, NotificationCount, ScoreType(..), displayScoreNow, filterEmails, filterMessages, filterSocials, getStringIfMatchFound, init, updateScore)
