module GameData exposing (GameData, NotificationCount, ScoreType(..), displayScoreNow, filterEmails, filterMessages, filterSocials, getStringIfMatchFound, init, updateScore)
