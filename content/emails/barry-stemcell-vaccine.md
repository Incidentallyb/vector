...
triggered_by:
  ...
  - init|start|mice|stemcell|feedback|score|step|stay|engage|feedback|score|step
  - init|start|mice|stemcell|feedback|score|step|stay|prosecute|feedback|score|step
choices:
  - pigs|Change to Pigs
  - mice|Change to Mice
  - fish|Change to Fish
