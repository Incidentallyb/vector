...
triggered_by:
  ...
  - init|start|macaques|step|change|step|pigs|step|scale|limit|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|scale|change|mice|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|scale|change|fish|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|phased|limit|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|phased|change|mice|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|phased|change|fish|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|share|limit|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|share|change|mice|step|score|nothing
  - init|start|macaques|step|change|step|pigs|step|share|change|fish|step|score|nothing
  - init|start|macaques|step|change|step|mice|step|scale|limit|score|nothing
  - init|start|macaques|step|change|step|mice|step|scale|fish|score|nothing
  - init|start|macaques|step|change|step|mice|step|phased|limit|score|nothing
  - init|start|macaques|step|change|step|mice|step|phased|fish|score|nothing
  - init|start|macaques|step|change|step|mice|step|share|limit|score|nothing
  - init|start|macaques|step|change|step|mice|step|share|fish|score|nothing
  - init|start|macaques|step|change|step|fish|step|scale|adult|score|nothing
  - init|start|macaques|step|change|step|fish|step|scale|embryo|score|nothing
  - init|start|macaques|step|change|step|fish|step|phased|adult|score|nothing
  - init|start|macaques|step|change|step|fish|step|phased|embryo|score|nothing
  - init|start|macaques|step|change|step|fish|step|share|adult|score|nothing
  - init|start|macaques|step|change|step|fish|step|share|embryo|score|nothing
  ...
  - init|start|macaques|step|change|step|pigs|step|scale|limit|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|scale|change|mice|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|scale|change|fish|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|phased|limit|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|phased|change|mice|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|phased|change|fish|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|share|limit|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|share|change|mice|step|score|one-extra
  - init|start|macaques|step|change|step|pigs|step|share|change|fish|step|score|one-extra
  - init|start|macaques|step|change|step|mice|step|scale|limit|score|one-extra
  - init|start|macaques|step|change|step|mice|step|scale|fish|score|one-extra
  - init|start|macaques|step|change|step|mice|step|phased|limit|score|one-extra
  - init|start|macaques|step|change|step|mice|step|phased|fish|score|one-extra
  - init|start|macaques|step|change|step|mice|step|share|limit|score|one-extra
  - init|start|macaques|step|change|step|mice|step|share|fish|score|one-extra
  - init|start|macaques|step|change|step|fish|step|scale|adult|score|one-extra
  - init|start|macaques|step|change|step|fish|step|scale|embryo|score|one-extra
  - init|start|macaques|step|change|step|fish|step|phased|adult|score|one-extra
  - init|start|macaques|step|change|step|fish|step|phased|embryo|score|one-extra
  - init|start|macaques|step|change|step|fish|step|share|adult|score|one-extra
  - init|start|macaques|step|change|step|fish|step|share|embryo|score|one-extra
  ...
  - init|start|macaques|step|change|step|pigs|step|scale|limit|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|scale|change|mice|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|scale|change|fish|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|phased|limit|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|phased|change|mice|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|phased|change|fish|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|share|limit|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|share|change|mice|step|score|two-extras
  - init|start|macaques|step|change|step|pigs|step|share|change|fish|step|score|two-extras
  - init|start|macaques|step|change|step|mice|step|scale|limit|score|two-extras
  - init|start|macaques|step|change|step|mice|step|scale|fish|score|two-extras
  - init|start|macaques|step|change|step|mice|step|phased|limit|score|two-extras
  - init|start|macaques|step|change|step|mice|step|phased|fish|score|two-extras
  - init|start|macaques|step|change|step|mice|step|share|limit|score|two-extras
  - init|start|macaques|step|change|step|mice|step|share|fish|score|two-extras
  - init|start|macaques|step|change|step|fish|step|scale|adult|score|two-extras
  - init|start|macaques|step|change|step|fish|step|scale|embryo|score|two-extras
  - init|start|macaques|step|change|step|fish|step|phased|adult|score|two-extras
  - init|start|macaques|step|change|step|fish|step|phased|embryo|score|two-extras
  - init|start|macaques|step|change|step|fish|step|share|adult|score|two-extras
  - init|start|macaques|step|change|step|fish|step|share|embryo|score|two-extras
